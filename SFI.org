...
** HOLD 注册两个 watchpoint 的 page fault
...
*** PROJ enable / disable watchpoint domain in context switching
    Update watchpoints.

[[file:~/Bionic-Builder/Kernel-SRC/linux/arch/arm64/kernel/hw_breakpoint.c::Update watchpoints.]]

*** HOLD inherit watchpoint domain in fork
